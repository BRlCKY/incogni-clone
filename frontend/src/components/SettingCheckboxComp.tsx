...
interface SettingCheckboxCompProps extends Omit<InputHTMLAttributes<HTMLInputElement>, "type"> {
    text: string;
}

const SettingCheckboxComp = ({ text, ...inputProps }: SettingCheckboxCompProps) => {
    return (
